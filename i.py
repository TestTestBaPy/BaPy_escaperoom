...
def handle_input(screen):
    ...
    input_rect = pygame.Rect(415, 130, 150, 115)
    ...
    while True:
        ...
        open_backroom(screen, vase_cracked = True, klappe_open = True, tuch_pushed=True)
        ...
        # be on screen
        pygame.draw.rect(screen, (0,250,250), input_rect)
